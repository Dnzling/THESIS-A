...
Route::prefix('inventory')->group(function () {
    ...
    Route::prefix('activity-logs')->group(function () {
        Route::get('/', [InventoryActivityLogController::class, 'index']);
        Route::get('/{id}', [InventoryActivityLogController::class, 'show']);
    });
    ...
    Route::prefix('transfers')->group(function () {
        ...
        Route::post('/{id}/send-to-logistics', [StockTransferController::class, 'sendToLogistics']);
        Route::post('/{id}/create-delivery', [StockTransferController::class, 'createDelivery']);
        Route::post('/{id}/delivery-log', [StockTransferController::class, 'addDeliveryLog']);
    ...
    Route::prefix('products')->group(function () {
        ...
        Route::post('/{id}/variations', [\App\Http\Controllers\Api\ProductCatalog\ProductVariationController::class, 'store']);
    ...
    Route::prefix('reorder-rules')->group(function () {
        ...
        Route::get('/basis-types', [ReorderRuleController::class, 'getBasisTypes']);
        ...
        Route::post('/auto-create', [ReorderRuleController::class, 'autoCreateFromInventory']);
    ...
    Route::prefix('ecommerce-deliveries')->group(function () {
        Route::get('/drivers', [EcommerceDeliveryController::class, 'drivers']);
        Route::get('/', [EcommerceDeliveryController::class, 'index']);
        Route::get('/{id}', [EcommerceDeliveryController::class, 'show']);
        Route::put('/{id}/status', [EcommerceDeliveryController::class, 'updateStatus']);
        Route::post('/{id}/assign-driver', [EcommerceDeliveryController::class, 'assignDriver']);
        Route::post('/{id}/proof', [EcommerceDeliveryController::class, 'uploadProof']);
        Route::get('/{id}/logs', [EcommerceDeliveryController::class, 'logs']);
        Route::post('/{id}/logs', [EcommerceDeliveryController::class, 'addLog']);
    });

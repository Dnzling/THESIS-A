<template>
  <section class="relative flex h-full w-full flex-col gap-8 overflow-hidden bg-gradient-to-br from-emerald-500 via-teal-600 to-cyan-700 p-8 text-white shadow-2xl lg:p-10">

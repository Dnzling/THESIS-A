...
const applyVerificationData = (data) => {
  ...
  verificationData.value = {
    ...
    storeName: data.store_name || data.storeName || verificationData.value.storeName,
    businessNumber: data.business_registration_number || data.businessNumber || verificationData.value.businessNumber,
    businessAddress: data.business_address || data.businessAddress || verificationData.value.businessAddress,
  }
}

onMounted(() => {
  applyVerificationData(props.verificationData)
})

watch(
  () => props.verificationData,
  (value) => {
    applyVerificationData(value)
  },
  { deep: true }
)

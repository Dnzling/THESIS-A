                ...
                ><template #content
                    ><form class="space-y-5" @submit.prevent="confirmSubmit">
                        <div class="grid gap-4 md:grid-cols-2">
                            <div
                                class="rounded-xl border border-orange-100 bg-orange-50/60 p-3"
                            >
                                <label
                                ...
                                <small class="text-slate-600"
                                    >Automatically assigned from your user
                                    profile.</small
                                ><small
                                    v-if="errors.branch_id"
                                    class="mt-1 block text-red-500"
                                    >{{ errors.branch_id }}</small
                                >
                            </div>
                            <div class="flex flex-col gap-1.5">
                                ...
                                ><Textarea
                                    v-model="form.reason"
                                    rows="2"
                                    placeholder="Why is replenishment required?"
                                /><small
                                    v-if="errors.reason"
                                    class="text-red-500"
                                    >{{ errors.reason }}</small
                        ...
                        <div class="rounded-lg border border-slate-200 p-3">
                            <div class="mb-3 flex items-center justify-between">
                                ...
                                <Button
                                    ...
                                    icon="pi pi-plus"
                                    size="small"
                                    :disabled="!form.branch_id || loading"
                                    @click="addItem"
                                />
                            </div>
                            <DataTable
                            ...
                            >
                                ...
                                <Column
                                    ...
                                    ><template #body="{ data, index }"
                                        ><Select
                                            v-model="data.branch_inventory_id"
                            ...
                            <div class="mt-4 flex justify-end">
                                <div
                                    class="w-full max-w-sm rounded-xl border border-slate-200 bg-slate-50 px-4 py-3"
                                >
                                    <div
...
const inventoryOptions = computed(() =>
    branchInventory.value
        .map((row) => {
            ...
            return {
                value: row.id,
                title: `${name}${row.variation?.variation_name ? ` - ${row.variation.variation_name}` : ""}`,

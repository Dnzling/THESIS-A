...
const load = async () => {
  const res = await crmService.getVouchers({ ...filters, per_page: 100 })
...
const goCreate = () => router.visit('/crm/vouchers/create')
const goShow = (id: number | string) => router.visit(`/crm/vouchers/${id}`)

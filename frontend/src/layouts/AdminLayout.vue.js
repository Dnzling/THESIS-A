...
var router = (0, vue_router_2.useRouter)();
...
var role = (0, lodash_1.startCase)(user === null || user === void 0 ? void 0 : user.role);
...
for (var _i = 0, _a = __VLS_vFor((__VLS_ctx.adminMenu)); _i < _a.length; _i++) {
    var item = _a[_i][0];
    var __VLS_0 = void 0;
...
// @ts-ignore
[handleLogout, route, route, firstName, lastName, role,];

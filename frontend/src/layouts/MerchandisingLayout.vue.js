...
var allNavigation = (0, vue_1.computed)(function () {
    return authStore.navigation
        ...
        return item.module === 'merchandising' &&
            !item.parent_id &&
            item.is_active;
    })
...
if (__VLS_ctx.loadingNavigation) {
    ...
    if (__VLS_ctx.allNavigation.length > 0) {
        ...
        for (var _i = 0, _a = __VLS_vFor((__VLS_ctx.allNavigation)); _i < _a.length; _i++) {
            var item = _a[_i][0];
            var __VLS_15 = void 0;
            ...
            // @ts-ignore
            [sidebarOpen, loadingNavigation, allNavigation, allNavigation,];
            var __VLS_18;
            // @ts-ignore
            [];
        }
...
(__VLS_ctx.route.meta.title || 'Product Catalog');
__VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)(__assign({ class: "text-sm text-gray-500" }));
/** @type {__VLS_StyleScopedClasses['text-sm']} */ ;
/** @type {__VLS_StyleScopedClasses['text-gray-500']} */ ;
(__VLS_ctx.route.meta.subtitle || 'Manage your furniture inventory');
...
// @ts-ignore
[toggleSidebar, route, route, openUserDialog, userInitials, fullName, roleDisplay,];
var __VLS_47;
...
routerLink;
// @ts-ignore
var __VLS_51 = __VLS_asFunctionalComponent1(__VLS_50, new __VLS_50(__assign({ to: "/merchandising/dashboard" }, { class: "text-gray-500 hover:text-blue-600" })));
var __VLS_52 = __VLS_51.apply(void 0, __spreadArray([__assign({ to: "/merchandising/dashboard" }, { class: "text-gray-500 hover:text-blue-600" })], __VLS_functionalComponentArgsRest(__VLS_51), false));
/** @type {__VLS_StyleScopedClasses['text-gray-500']} */ ;
/** @type {__VLS_StyleScopedClasses['hover:text-blue-600']} */ ;
...
if (__VLS_ctx.breadcrumbs.length > 0) {
    for (var _b = 0, _c = __VLS_vFor((__VLS_ctx.breadcrumbs)); _b < _c.length; _b++) {
        var _d = _c[_b], crumb = _d[0], index = _d[1];
        (index);
        __VLS_asFunctionalElement1(__VLS_intrinsics.i, __VLS_intrinsics.i)(__assign({ class: "pi pi-angle-right text-gray-400 text-xs" }));
        /** @type {__VLS_StyleScopedClasses['pi']} */ ;
        /** @type {__VLS_StyleScopedClasses['pi-angle-right']} */ ;

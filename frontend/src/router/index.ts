...
const routes: RouteRecordRaw[] = [
...

  {
    ...
    children: [
      ...
      { path: 'chats', name: 'ecommerce.chats', component: () => import('../views/system/ecommerce/EcommerceChats.vue'), meta: { title: 'Chats', requiresAuth: true } },
  ...
  },
  {
    ...
    meta: { requiresAuth: true },
    children: [
      { path: 'dashboard', name: 'sales.dashboard', component: () => import('../views/system/sales/SalesDashboard.vue'), meta: { title: 'Sales Dashboard', permission: 'sales.dashboard.view' } },
      { path: 'crm', name: 'sales.crm', component: () => import('../views/system/sales/SalesCRM.vue'), meta: { title: 'CRM Leads', permission: 'sales.crm.view' } },
      { path: 'chats', name: 'sales.chats', component: () => import('../views/system/sales/SalesChats.vue'), meta: { title: 'Customer Chats', permission: 'sales.chats.view' } },
      { path: 'pos/overview', name: 'sales.pos.overview', component: () => import('../views/system/sales/SalesPOSOverview.vue'), meta: { title: 'POS Overview', permission: 'sales.pos.view' } },
      { path: 'pos', name: 'sales.pos', component: () => import('../views/system/sales/SalesPOS.vue'), meta: { title: 'In-Store POS', permission: 'sales.pos.view' } },
      { path: 'pos/orders/:id', name: 'sales.pos.order-detail', component: () => import('../views/system/sales/SalesPOSOrderDetail.vue'), meta: { title: 'POS Order Detail', permission: 'sales.pos.view' } },
      { path: 'deliveries', name: 'sales.deliveries', component: () => import('../views/system/sales/SalesOrderDeliveriesIndex.vue'), meta: { title: 'Sales Deliveries', permission: 'sales.deliveries.view' } },
      { path: 'deliveries/:id', name: 'sales.deliveries.detail', component: () => import('../views/system/sales/SalesOrderDeliveryDetail.vue'), meta: { title: 'Delivery Detail', permission: 'sales.deliveries.view' } },
      { path: 'ecommerce-orders', name: 'sales.ecommerce-orders', component: () => import('../views/system/inventory/EcommerceOrders/EcommerceOrderIndex.vue'), meta: { title: 'Ecommerce Orders', permission: 'sales.ecommerce-orders.view' } },
      { path: 'ecommerce-orders/:id', name: 'sales.ecommerce-orders.detail', component: () => import('../views/system/inventory/EcommerceOrders/EcommerceOrderDetail.vue'), meta: { title: 'Order Detail', permission: 'sales.ecommerce-orders.view' } },
  ...
  },
  {
    ...
    meta: { requiresAuth: true },
    children: [
      { path: 'dashboard', name: 'procurement.dashboard', component: () => import('../views/system/procurement/Dashboard.vue'), meta: { title: 'Procurement Dashboard', subtitle: 'Overview of procurement operations', permission: 'procurement.dashboard.view' } },
      { path: 'suppliers', name: 'procurement.suppliers', component: () => import('../views/system/procurement/Suppliers/SupplierIndex.vue'), meta: { title: 'Suppliers', subtitle: 'Manage supplier records', permission: 'procurement.suppliers.view' } },
      { path: 'suppliers/create', name: 'procurement.suppliers.create', component: () => import('../views/system/procurement/Suppliers/SupplierCreate.vue'), meta: { title: 'Create Supplier', subtitle: 'Add a supplier profile', permission: 'procurement.suppliers.manage' } },
      { path: 'suppliers/:id', name: 'procurement.suppliers.detail', component: () => import('../views/system/procurement/Suppliers/SupplierDetail.vue'), meta: { title: 'Supplier Details', subtitle: 'View supplier information', permission: 'procurement.suppliers.view' } },
      { path: 'suppliers/:id/edit', name: 'procurement.suppliers.edit', component: () => import('../views/system/procurement/Suppliers/SupplierEdit.vue'), meta: { title: 'Edit Supplier', subtitle: 'Update supplier information', permission: 'procurement.suppliers.manage' } },
      { path: 'supplier-contracts', name: 'procurement.supplier-contracts.index', component: () => import('../views/system/procurement/SupplierContracts/SupplierContractIndex.vue'), meta: { title: 'Supplier Contracts', subtitle: 'Manage supplier contracts with terms and documents', permission: 'procurement.supplier_contracts.view' } },
      { path: 'supplier-contracts/create', name: 'procurement.supplier-contracts.create', component: () => import('../views/system/procurement/SupplierContracts/SupplierContractCreate.vue'), meta: { title: 'Create Contract', subtitle: 'Create a new supplier contract', permission: 'procurement.supplier_contracts.manage' } },
      { path: 'supplier-contracts/:id', name: 'procurement.supplier-contracts.detail', component: () => import('../views/system/procurement/SupplierContracts/SupplierContractDetail.vue'), meta: { title: 'Contract Details', subtitle: 'View contract information', permission: 'procurement.supplier_contracts.view' } },
      { path: 'supplier-contracts/:id/edit', name: 'procurement.supplier-contracts.edit', component: () => import('../views/system/procurement/SupplierContracts/SupplierContractEdit.vue'), meta: { title: 'Edit Contract', subtitle: 'Update contract details', permission: 'procurement.supplier_contracts.manage' } },
      { path: 'purchase-requisitions', name: 'procurement.purchase-requisitions', component: () => import('../views/system/procurement/PurchaseRequisitions/PurchaseRequisitionIndex.vue'), meta: { title: 'Purchase Requisitions', subtitle: 'Manage requisitions', permission: 'procurement.requisitions.view' } },
      { path: 'purchase-requisitions/create', name: 'procurement.purchase-requisitions.create', component: () => import('../views/system/procurement/PurchaseRequisitions/PurchaseRequisitionCreate.vue'), meta: { title: 'Create Requisition', subtitle: 'Create a purchase requisition', permission: 'procurement.requisitions.manage' } },
      { path: 'purchase-requisitions/:id', name: 'procurement.purchase-requisitions.detail', component: () => import('../views/system/procurement/PurchaseRequisitions/PurchaseRequisitionDetail.vue'), meta: { title: 'Requisition Details', subtitle: 'Review requisition details', permission: 'procurement.requisitions.view' } },
      { path: 'rfqs', name: 'procurement.rfqs', component: () => import('../views/system/procurement/RFQs/RFQIndex.vue'), meta: { title: 'RFQs', subtitle: 'Manage requests for quotations', permission: 'procurement.rfq.view' } },
      { path: 'rfqs/create', name: 'procurement.rfqs.create', component: () => import('../views/system/procurement/RFQs/RFQCreate.vue'), meta: { title: 'Create RFQ', subtitle: 'Create a request for quotation', permission: 'procurement.rfq.manage' } },
      { path: 'rfqs/:id', name: 'procurement.rfqs.detail', component: () => import('../views/system/procurement/RFQs/RFQDetail.vue'), meta: { title: 'RFQ Details', subtitle: 'Review RFQ details', permission: 'procurement.rfq.view' } },
      { path: 'purchase-orders', name: 'procurement.purchase-orders', component: () => import('../views/system/procurement/PurchaseOrders/PurchaseOrderIndex.vue'), meta: { title: 'Purchase Orders', subtitle: 'Manage purchase orders', permission: 'procurement.purchase_orders.view' } },
      { path: 'purchase-orders/create', name: 'procurement.purchase-orders.create', component: () => import('../views/system/procurement/PurchaseOrders/PurchaseOrderCreate.vue'), meta: { title: 'Create Purchase Order', subtitle: 'Create a purchase order from stock requests', permission: 'procurement.purchase_orders.manage' } },
      { path: 'purchase-orders/:id', name: 'procurement.purchase-orders.detail', component: () => import('../views/system/procurement/PurchaseOrders/PurchaseOrderDetail.vue'), meta: { title: 'Purchase Order Details', subtitle: 'Review purchase order details', permission: 'procurement.purchase_orders.view' } },
      { path: 'invoices', name: 'procurement.invoices', component: () => import('../views/system/procurement/Invoices/InvoiceIndex.vue'), meta: { title: 'Invoices', subtitle: 'Manage supplier invoices and 3-way matching', permission: 'procurement.invoices.view' } },
      { path: 'invoices/create', name: 'procurement.invoices.create', component: () => import('../views/system/procurement/Invoices/InvoiceCreate.vue'), meta: { title: 'Create Invoice', subtitle: 'Create a new invoice', permission: 'procurement.invoices.manage' } },
      { path: 'invoices/:id', name: 'procurement.invoices.detail', component: () => import('../views/system/procurement/Invoices/InvoiceDetail.vue'), meta: { title: 'Invoice Details', subtitle: 'View invoice details and 3-way match status', permission: 'procurement.invoices.view' } },
      { path: 'invoices/:id/edit', name: 'procurement.invoices.edit', component: () => import('../views/system/procurement/Invoices/InvoiceEdit.vue'), meta: { title: 'Edit Invoice', subtitle: 'Edit invoice information', permission: 'procurement.invoices.manage' } },
      { path: 'goods-receipts', name: 'procurement.goods-receipts', component: () => import('../views/system/procurement/GoodsReceipts/GoodsReceiptIndex.vue'), meta: { title: 'Goods Receipts', subtitle: 'Track incoming goods', permission: 'procurement.receiving.view' } },
      { path: 'goods-receipts/create', name: 'procurement.goods-receipts.create', component: () => import('../views/system/procurement/GoodsReceipts/GoodsReceiptCreate.vue'), meta: { title: 'Create Goods Receipt', subtitle: 'Record incoming goods', permission: 'procurement.receiving.manage' } },
      { path: 'goods-receipts/:id', name: 'procurement.goods-receipts.detail', component: () => import('../views/system/procurement/GoodsReceipts/GoodsReceiptDetail.vue'), meta: { title: 'Goods Receipt Details', subtitle: 'View receipt details', permission: 'procurement.receiving.view' } },
      { path: 'products', name: 'procurement.products', component: () => import('../views/system/procurement/ProductsIndex.vue'), meta: { title: 'Products', subtitle: 'Procurement product catalog with supplier pricing', permission: 'procurement.products.view' } },
      // Analytics Routes
      { path: 'analytics/reorder-suggestions', name: 'procurement.analytics.reorder-suggestions', component: () => import('../views/system/procurement/Analytics/ReorderSuggestions.vue'), meta: { title: 'Reorder Suggestions', subtitle: 'Products below reorder point', permission: 'procurement.analytics.view' } },
      { path: 'analytics/spend', name: 'procurement.analytics.spend', component: () => import('../views/system/procurement/Analytics/SpendAnalytics.vue'), meta: { title: 'Spend Analytics', subtitle: 'Analyze spending trends and patterns', permission: 'procurement.analytics.view' } },
      { path: 'analytics/budget', name: 'procurement.analytics.budget', component: () => import('../views/system/procurement/Analytics/BudgetTracking.vue'), meta: { title: 'Budget Tracking', subtitle: 'Monitor spending against budgets', permission: 'procurement.analytics.view' } },
      { path: 'analytics/suppliers', name: 'procurement.analytics.suppliers', component: () => import('../views/system/procurement/Analytics/SupplierPerformance.vue'), meta: { title: 'Supplier Performance', subtitle: 'Track supplier metrics and ratings', permission: 'procurement.analytics.view' } },
      { path: 'analytics/lead-time', name: 'procurement.analytics.lead-time', component: () => import('../views/system/procurement/Analytics/LeadTimeMonitoring.vue'), meta: { title: 'Lead Time Monitoring', subtitle: 'Track delivery performance and trends', permission: 'procurement.analytics.view' } },
      { path: 'payments', name: 'procurement.payments', component: () => import('../views/system/procurement/Payments/PaymentIndex.vue'), meta: { title: 'Supplier Payments', subtitle: 'Manage supplier payments', permission: 'procurement.payments.view' } },
      { path: 'reports', name: 'procurement.reports', component: () => import('../views/system/procurement/Reports/ReportIndex.vue'), meta: { title: 'Procurement Reports', subtitle: 'Analyze procurement performance', permission: 'procurement.reports.view' } },
      { path: 'settings/workflow', name: 'procurement.settings.workflow', component: () => import('../views/system/procurement/Settings/WorkflowSettings.vue'), meta: { title: 'Workflow Settings', subtitle: 'Business-size based approval policy', permission: 'procurement.settings.manage' } },

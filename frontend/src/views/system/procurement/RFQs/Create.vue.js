    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, procurement_service_1.default.createRFQ(form)];
            case 2:
                _a.sent();
            ...
            case 3:
                error_1 = _a.sent();
                console.error('Failed to create RFQ', error_1);
                return [3 /*break*/, 5];
            case 4:
                saving.value = false;
                return [7 /*endfinally*/];
...
var __VLS_12 = __VLS_10.slots.default;
{
    ...
    var __VLS_25 = __VLS_asFunctionalComponent1(__VLS_24, new __VLS_24({
        modelValue: (__VLS_ctx.form.deadline_date),
        placeholder: "YYYY-MM-DD",
    }));
    ...
    Button;
    // @ts-ignore
    var __VLS_35 = __VLS_asFunctionalComponent1(__VLS_34, new __VLS_34(__assign({ 'onClick': {} }, { label: "Cancel", severity: "secondary", text: true, type: "button" })));
    var __VLS_36 = __VLS_35.apply(void 0, __spreadArray([__assign({ 'onClick': {} }, { label: "Cancel", severity: "secondary", text: true, type: "button" })], __VLS_functionalComponentArgsRest(__VLS_35), false));
    var __VLS_39 = void 0;
    var __VLS_40 = ({ click: {} },
        { onClick: function () {
                var _a = [];
                ...
                __VLS_ctx.router.push({ name: 'procurement.rfqs' });
                // @ts-ignore
                [router, submitForm, form, form, form, form,];
            } });
    var __VLS_37;
    var __VLS_38;
    var __VLS_41 = void 0;

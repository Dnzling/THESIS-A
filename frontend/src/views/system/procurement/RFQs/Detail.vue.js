...
var rfqId = Number(route.params.id);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, procurement_service_1.default.getRFQ(rfqId)];
            case 2:
                response = _a.sent();
            ...
            case 3:
                error_1 = _a.sent();
                console.error('Failed to load RFQ detail', error_1);
                detail.value = null;
                return [3 /*break*/, 5];
            case 4:
                loading.value = false;
...
var send = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, , 4, 5]);
                return [4 /*yield*/, procurement_service_1.default.sendRFQ(rfqId)];
            case 2:
                _a.sent();
...
var close = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, , 4, 5]);
                return [4 /*yield*/, procurement_service_1.default.closeRFQ(rfqId)];
            case 2:
                _a.sent();
                return [4 /*yield*/, loadDetail()];
            case 3:
...
var award = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                processing.value = true;
            ...
            case 1:
                _a.trys.push([1, , 4, 5]);
                return [4 /*yield*/, procurement_service_1.default.awardRFQ(rfqId)];
            case 2:
                _a.sent();
                return [4 /*yield*/, loadDetail()];
            case 3:
...
var __VLS_6 = ({ click: {} },
    { onClick: function () {
            ...
            var $event = _a[0];
            __VLS_ctx.router.push({ name: 'procurement.rfqs' });
            // @ts-ignore
            [router,];
        } });
var __VLS_3;
...
if (__VLS_ctx.loading) {
    ...
    var __VLS_17 = __VLS_15.slots.default;
    {
        ...
        // @ts-ignore
        [detail, detail, statusSeverity, loading,];
    }
    // @ts-ignore
    [];
    var __VLS_15;
    ...
    var __VLS_29 = __VLS_27.slots.default;
    {
        ...
        (((_e = __VLS_ctx.detail) === null || _e === void 0 ? void 0 : _e.rfq_number) || '-');
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({});
        __VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)(__assign({ class: "text-xs text-gray-600" }));
        /** @type {__VLS_StyleScopedClasses['text-xs']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-gray-600']} */ ;
        ...
        /** @type {__VLS_StyleScopedClasses['font-semibold']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-gray-900']} */ ;
        (((_f = __VLS_ctx.detail) === null || _f === void 0 ? void 0 : _f.title) || '-');
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({});
        __VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)(__assign({ class: "text-xs text-gray-600" }));
        /** @type {__VLS_StyleScopedClasses['text-xs']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-gray-600']} */ ;
        ...
        /** @type {__VLS_StyleScopedClasses['font-semibold']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-gray-900']} */ ;
        (((_g = __VLS_ctx.detail) === null || _g === void 0 ? void 0 : _g.deadline_date) || '-');
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "pt-2 flex gap-2 justify-end" }));
        ...
        Button;
        // @ts-ignore
        var __VLS_32 = __VLS_asFunctionalComponent1(__VLS_31, new __VLS_31(__assign({ 'onClick': {} }, { label: "Send", icon: "pi pi-send", severity: "info", loading: (__VLS_ctx.processing) })));
        var __VLS_33 = __VLS_32.apply(void 0, __spreadArray([__assign({ 'onClick': {} }, { label: "Send", icon: "pi pi-send", severity: "info", loading: (__VLS_ctx.processing) })], __VLS_functionalComponentArgsRest(__VLS_32), false));
        var __VLS_36 = void 0;
        var __VLS_37 = ({ click: {} },
        ...
        Button;
        // @ts-ignore
        var __VLS_39 = __VLS_asFunctionalComponent1(__VLS_38, new __VLS_38(__assign({ 'onClick': {} }, { label: "Close", icon: "pi pi-times", severity: "warning", loading: (__VLS_ctx.processing) })));
        var __VLS_40 = __VLS_39.apply(void 0, __spreadArray([__assign({ 'onClick': {} }, { label: "Close", icon: "pi pi-times", severity: "warning", loading: (__VLS_ctx.processing) })], __VLS_functionalComponentArgsRest(__VLS_39), false));
        var __VLS_43 = void 0;
        var __VLS_44 = ({ click: {} },
        ...
        Button;
        // @ts-ignore
        var __VLS_46 = __VLS_asFunctionalComponent1(__VLS_45, new __VLS_45(__assign({ 'onClick': {} }, { label: "Award", icon: "pi pi-check", severity: "success", loading: (__VLS_ctx.processing) })));
        var __VLS_47 = __VLS_46.apply(void 0, __spreadArray([__assign({ 'onClick': {} }, { label: "Award", icon: "pi pi-check", severity: "success", loading: (__VLS_ctx.processing) })], __VLS_functionalComponentArgsRest(__VLS_46), false));
        var __VLS_50 = void 0;
        var __VLS_51 = ({ click: {} },
            { onClick: (__VLS_ctx.award) });
        var __VLS_48;
        var __VLS_49;
        // @ts-ignore
        [detail, detail, detail, processing, processing, processing, send, close, award,];
    }
    // @ts-ignore
    [];
    var __VLS_27;

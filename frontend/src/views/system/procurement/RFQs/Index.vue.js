...
var rfqs = (0, vue_1.ref)([]);
var loadRFQs = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, procurement_service_1.default.getRFQs()];
            case 2:
                response = _b.sent();
                rfqs.value = ((_a = response.data) === null || _a === void 0 ? void 0 : _a.data) || [];
                return [3 /*break*/, 5];
            case 3:
                error_1 = _b.sent();
                console.error('Failed to load RFQs', error_1);
                rfqs.value = [];
                return [3 /*break*/, 5];
            case 4:
                loading.value = false;
...
Button;
// @ts-ignore
var __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0(__assign({ 'onClick': {} }, { label: "Create RFQ", icon: "pi pi-plus", severity: "success" })));
var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign({ 'onClick': {} }, { label: "Create RFQ", icon: "pi pi-plus", severity: "success" })], __VLS_functionalComponentArgsRest(__VLS_1), false));
var __VLS_5;
var __VLS_6 = ({ click: {} },
    { onClick: function () {
            var _a = [];
...
var __VLS_12 = __VLS_10.slots.default;
{
    ...
    DataTable;
    // @ts-ignore
    var __VLS_15 = __VLS_asFunctionalComponent1(__VLS_14, new __VLS_14(__assign(__assign({ value: (__VLS_ctx.rfqs), loading: (__VLS_ctx.loading) }, { class: "p-datatable-sm" }), { stripedRows: true })));
    var __VLS_16 = __VLS_15.apply(void 0, __spreadArray([__assign(__assign({ value: (__VLS_ctx.rfqs), loading: (__VLS_ctx.loading) }, { class: "p-datatable-sm" }), { stripedRows: true })], __VLS_functionalComponentArgsRest(__VLS_15), false));
    ...
    var __VLS_52 = __VLS_50.slots.default;
    {
        ...
        var __VLS_60 = ({ click: {} },
            { onClick: function () {
                    ...
                    var $event = _a[0];
                    __VLS_ctx.router.push({ name: 'procurement.rfqs.detail', params: { id: data_1.id } });
                    // @ts-ignore
                    [router,];
                } });
        var __VLS_57;

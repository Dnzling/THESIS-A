...
var loadSupplier = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_1 = _a.sent();
                console.error('Failed to load supplier', error_1);
                return [3 /*break*/, 5];
            case 4:
                loading.value = false;
                return [7 /*endfinally*/];
...
var submitForm = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, 4, 5]);
                return [4 /*yield*/, procurement_service_1.default.updateSupplier(supplierId, form)];
            case 2:
                _a.sent();
            ...
            case 3:
                error_2 = _a.sent();
                console.error('Failed to update supplier', error_2);
                return [3 /*break*/, 5];
            case 4:
                saving.value = false;
                return [7 /*endfinally*/];
...
if (__VLS_ctx.loading) {
    ...
    Skeleton;
    // @ts-ignore
    var __VLS_8 = __VLS_asFunctionalComponent1(__VLS_7, new __VLS_7(__assign({ height: "220px" }, { class: "rounded-lg" })));
    var __VLS_9 = __VLS_8.apply(void 0, __spreadArray([__assign({ height: "220px" }, { class: "rounded-lg" })], __VLS_functionalComponentArgsRest(__VLS_8), false));
    ...
    {
        var __VLS_23 = __VLS_20.slots.content;
        ...
        Button;
        // @ts-ignore
        var __VLS_60 = __VLS_asFunctionalComponent1(__VLS_59, new __VLS_59(__assign({ 'onClick': {} }, { label: "Cancel", severity: "secondary", text: true, type: "button" })));
        var __VLS_61 = __VLS_60.apply(void 0, __spreadArray([__assign({ 'onClick': {} }, { label: "Cancel", severity: "secondary", text: true, type: "button" })], __VLS_functionalComponentArgsRest(__VLS_60), false));
        var __VLS_64 = void 0;
        var __VLS_65 = ({ click: {} },
            { onClick: function () {
                    var _a = [];
                    ...
                    __VLS_ctx.router.push({ name: 'procurement.suppliers' });
                    // @ts-ignore
                    [router, loading, submitForm, form, form, form, form, form, form, form, statuses,];
                } });
        var __VLS_62;
        var __VLS_63;
        var __VLS_66 = void 0;

...
var poId = Number(route.params.id);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, procurement_service_1.default.getPurchaseOrder(poId)];
            case 2:
                response = _a.sent();
            ...
            case 3:
                error_1 = _a.sent();
                console.error('Failed to load purchase order detail', error_1);
                detail.value = null;
                return [3 /*break*/, 5];
            case 4:
                loading.value = false;
...
var approve = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, , 4, 5]);
                return [4 /*yield*/, procurement_service_1.default.approvePurchaseOrder(poId)];
            case 2:
                _a.sent();
...
var reject = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, , 4, 5]);
                return [4 /*yield*/, procurement_service_1.default.rejectPurchaseOrder(poId)];
            case 2:
                _a.sent();
                return [4 /*yield*/, loadDetail()];
            case 3:
...
var send = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, , 4, 5]);
                return [4 /*yield*/, procurement_service_1.default.sendPurchaseOrder(poId)];
            case 2:
                _a.sent();
                return [4 /*yield*/, loadDetail()];
            case 3:
...
var cancel = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, , 4, 5]);
                return [4 /*yield*/, procurement_service_1.default.cancelPurchaseOrder(poId)];
            case 2:
                _a.sent();
                return [4 /*yield*/, loadDetail()];
            case 3:
...
if (__VLS_ctx.loading) {
    ...
    Skeleton;
    // @ts-ignore
    var __VLS_13 = __VLS_asFunctionalComponent1(__VLS_12, new __VLS_12(__assign({ height: "220px" }, { class: "rounded-lg" })));
    var __VLS_14 = __VLS_13.apply(void 0, __spreadArray([__assign({ height: "220px" }, { class: "rounded-lg" })], __VLS_functionalComponentArgsRest(__VLS_13), false));
    ...
    var __VLS_27 = __VLS_25.slots.default;
    {
        ...
        (((_e = __VLS_ctx.detail) === null || _e === void 0 ? void 0 : _e.po_number) || '-');
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({});
        __VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)(__assign({ class: "text-xs text-gray-600" }));
        /** @type {__VLS_StyleScopedClasses['text-xs']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-gray-600']} */ ;
        ...
        /** @type {__VLS_StyleScopedClasses['font-semibold']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-gray-900']} */ ;
        (((_f = __VLS_ctx.detail) === null || _f === void 0 ? void 0 : _f.order_date) || '-');
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({});
        __VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)(__assign({ class: "text-xs text-gray-600" }));
        /** @type {__VLS_StyleScopedClasses['text-xs']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-gray-600']} */ ;
        ...
        /** @type {__VLS_StyleScopedClasses['font-semibold']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-gray-900']} */ ;
        (((_g = __VLS_ctx.detail) === null || _g === void 0 ? void 0 : _g.expected_delivery_date) || '-');
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({});
        __VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)(__assign({ class: "text-xs text-gray-600" }));
        /** @type {__VLS_StyleScopedClasses['text-xs']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-gray-600']} */ ;
        ...
        /** @type {__VLS_StyleScopedClasses['font-semibold']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-gray-900']} */ ;
        (((_j = (_h = __VLS_ctx.detail) === null || _h === void 0 ? void 0 : _h.supplier) === null || _j === void 0 ? void 0 : _j.supplier_name) || '-');
        // @ts-ignore
    ...
    }
    {
        ...
        DataTable;
        // @ts-ignore
        var __VLS_38 = __VLS_asFunctionalComponent1(__VLS_37, new __VLS_37(__assign(__assign({ value: (((_k = __VLS_ctx.detail) === null || _k === void 0 ? void 0 : _k.items) || []) }, { class: "p-datatable-sm" }), { stripedRows: true })));
        var __VLS_39 = __VLS_38.apply(void 0, __spreadArray([__assign(__assign({ value: (((_l = __VLS_ctx.detail) === null || _l === void 0 ? void 0 : _l.items) || []) }, { class: "p-datatable-sm" }), { stripedRows: true })], __VLS_functionalComponentArgsRest(__VLS_38), false));
        ...
        Button;
        // @ts-ignore
        var __VLS_78 = __VLS_asFunctionalComponent1(__VLS_77, new __VLS_77(__assign({ 'onClick': {} }, { label: "Send", icon: "pi pi-send", severity: "info", loading: (__VLS_ctx.processing) })));
        var __VLS_79 = __VLS_78.apply(void 0, __spreadArray([__assign({ 'onClick': {} }, { label: "Send", icon: "pi pi-send", severity: "info", loading: (__VLS_ctx.processing) })], __VLS_functionalComponentArgsRest(__VLS_78), false));
        var __VLS_82 = void 0;
        var __VLS_83 = ({ click: {} },
        ...
        Button;
        // @ts-ignore
        var __VLS_85 = __VLS_asFunctionalComponent1(__VLS_84, new __VLS_84(__assign({ 'onClick': {} }, { label: "Cancel", icon: "pi pi-ban", severity: "warning", loading: (__VLS_ctx.processing) })));
        var __VLS_86 = __VLS_85.apply(void 0, __spreadArray([__assign({ 'onClick': {} }, { label: "Cancel", icon: "pi pi-ban", severity: "warning", loading: (__VLS_ctx.processing) })], __VLS_functionalComponentArgsRest(__VLS_85), false));
        var __VLS_89 = void 0;
        var __VLS_90 = ({ click: {} },
        ...
        var __VLS_88;
        // @ts-ignore
        [processing, processing, processing, processing, reject, approve, send, cancel,];
    }
    // @ts-ignore
    [];
    var __VLS_32;

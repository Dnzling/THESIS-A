    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, procurement_service_1.default.createPurchaseOrder(form)];
            case 2:
                _a.sent();
            ...
            case 3:
                error_1 = _a.sent();
                console.error('Failed to create purchase order', error_1);
                return [3 /*break*/, 5];
            case 4:
                saving.value = false;
                return [7 /*endfinally*/];
...
var __VLS_12 = __VLS_10.slots.default;
{
    ...
    var __VLS_30 = __VLS_asFunctionalComponent1(__VLS_29, new __VLS_29({
        modelValue: (__VLS_ctx.form.expected_delivery_date),
        placeholder: "YYYY-MM-DD",
    }));
    ...
    var __VLS_35 = __VLS_asFunctionalComponent1(__VLS_34, new __VLS_34({
        modelValue: (__VLS_ctx.form.payment_terms),
    ...
    Button;
    // @ts-ignore
    var __VLS_45 = __VLS_asFunctionalComponent1(__VLS_44, new __VLS_44(__assign({ 'onClick': {} }, { label: "Cancel", severity: "secondary", text: true, type: "button" })));
    var __VLS_46 = __VLS_45.apply(void 0, __spreadArray([__assign({ 'onClick': {} }, { label: "Cancel", severity: "secondary", text: true, type: "button" })], __VLS_functionalComponentArgsRest(__VLS_45), false));
    var __VLS_49 = void 0;
    var __VLS_50 = ({ click: {} },
        { onClick: function () {
                var _a = [];
                ...
                __VLS_ctx.router.push({ name: 'procurement.purchase-orders' });
                // @ts-ignore
                [router, submitForm, form, form, form, form, form, form,];
            } });
    var __VLS_47;
    var __VLS_48;
    var __VLS_51 = void 0;

<template>
  <div class="p-4 min-h-screen">
    <div class="mb-4 flex justify-between items-center">
      ...
      <Button label="Create Requisition" icon="pi pi-plus" severity="success"
        @click="router.push({ name: 'requisites.create' })" size="small" />
    </div>
      ...
      <template #content>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-3 items-end">
          <div class="flex flex-col gap-2">
            ...
            <InputText v-model="filterSearch" placeholder="PR no, reason, requester, branch" />
          </div>
          <div class="flex flex-col gap-2">
          ...
          <div class="flex flex-col gap-2">
            ...
            <Select v-model="filterType" :options="requisitionTypeOptions" optionLabel="label" optionValue="value"
              placeholder="All Types" showClear />
          </div>
          <div class="flex flex-col gap-2">
    ...
    <Card>
      <template #content>
        <DataTable :value="requisitions" :loading="loading" class="p-datatable-sm" stripedRows
          ...
          @sort="onSort" :sortField="sortField" :sortOrder="sortOrder">
          ...
          <Column field="pr_number" header="PR No." sortable style="width: 150px">
            <template #body="{ data }">
          ...
          <Column header="Actions" style="width: 160px">
            <template #body="{ data }">
              <div class="flex gap-2 items-center justify-start">
                ...
                <Button v-if="approvedStatuses.includes(data.status) && data.any_item_missing_supplier" icon="pi pi-send"
                  outlined rounded severity="success" @click="createRfqFromRequisition(data.id)"
                  v-tooltip="'Create RFQ'" />
                <Button v-if="approvedStatuses.includes(data.status) && data.all_items_have_suppliers"
...
watch([filterStatus, filterType, perPage, filterSearch], () => {
  loadRequisitions(1)
})
</script>

      ...
      <template #content>
        <form class="space-y-4" @submit.prevent="submit">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label class="text-xs font-semibold text-gray-600">Rule Type <span class="text-red-500">*</span></label>
              <Select v-model="form.rule_type" :options="ruleTypeOptions" optionLabel="label" optionValue="value" class="w-full mt-1" />
            </div>

            <div>
              <label class="text-xs font-semibold text-gray-600">Trigger Type <span class="text-red-500">*</span></label>
            ...
            <div v-if="form.basis_type === 'demand_lead_time'">
              <label class="text-xs font-semibold text-gray-600">Average Daily Demand <span class="text-red-500">*</span></label>

    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, axios_1.default.get('/api/inventory/dashboard/stats')];
            case 2:
                response = _d.sent();
                if ((_a = response.data) === null || _a === void 0 ? void 0 : _a.data) {
                    dashboardData.value = __assign(__assign({}, dashboardData.value), response.data.data);
            ...
            case 3:
                ...
                toast.add({
                    severity: 'error',
                    summary: 'Error',
                    detail: ((_c = (_b = error_1.response) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.message) || 'Failed to load dashboard data',
                    life: 3000
                });
                return [3 /*break*/, 5];
            case 4:

...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('crm_return_investigation_tickets')) {
            Schema::create('crm_return_investigation_tickets', function (Blueprint $table): void {
                ...
                $table->index(['store_id', 'status'], 'crm_ret_ticket_store_status_idx');
                $table->index('expected_investigation_date', 'crm_ret_ticket_expected_date_idx');
            });
        }

        if (! Schema::hasTable('crm_return_investigation_assignees')) {
            Schema::create('crm_return_investigation_assignees', function (Blueprint $table): void {
                ...
                $table->index(['user_id', 'ticket_id'], 'crm_ret_assignee_user_ticket_idx');
            });
        }
    }
